...
<script type="text/javascript">
    $(function () {
        $("#div_register input[name='userCode']").blur(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/mess/ckusr",
                "type": "PUT",
                "data": {"name": userCode},
                "dataType": "json",
        ...
        $("#tijiao").click(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/message/doregister",
                "type": "POST",
                "data": arrs,
                ...
                "success": function (data) {
                    ...
                    if (data.success == "true") {
                        console.log("注册成功，短信发送成功");
                        $("#div_activate").css("display", "block");
                    } else {
                        console.log("注册失败，短信发送失败");
                        $("#div_activate_fail").html("注册失败，短信发送失败");
                    }
                }
            });
        });
        ...
        $("#activateTijiao").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/message/activate?user=" + user + "&code=" + code;
            $.ajax({
                "url": url,
                "type": "POST",
                "dataType": "json",
